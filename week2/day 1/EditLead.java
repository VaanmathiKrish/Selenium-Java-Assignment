...
public class EditLead {
	...
	public static void main(String[] args) {
		...
		//Locate Edit button & click
		driver.findElement(By.linkText("Edit")).click();

		//Locate Description and clear it
		driver.findElement(By.id("updateLeadForm_description")).clear();

		//Locate ImportantNote and clear it
		driver.findElement(By.id("updateLeadForm_importantNote")).sendKeys("Lead details updated"); 
